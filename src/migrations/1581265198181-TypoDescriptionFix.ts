...
export class TypoDescriptionFix1581265198181 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `agenda_item` ADD `descriptionNL` varchar(16382) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `agenda_item` ADD `descriptionEN` varchar(16382) NOT NULL", undefined);
    }
