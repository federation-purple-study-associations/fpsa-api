...
export class AlterDescriptionLength1581256205218 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `agenda_item` ADD `desciptionNL` varchar(65535) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `agenda_item` DROP COLUMN `desciptionEN`", undefined);
        await queryRunner.query("ALTER TABLE `agenda_item` ADD `desciptionEN` varchar(65535) NOT NULL", undefined);
    }
